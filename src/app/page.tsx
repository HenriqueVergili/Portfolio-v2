...
import Aside from './components/header1';
...
const HomePage: React.FC = () => {
  ...
  return (
    <div className='bg-gradient-custom'>
      <div id="home" className='bg-gradient-custom container'>
        ...
        <div className='flex justify-between'>
          <div className='animate-[tada_1s_ease-in-out] mt-32'>
            <p className='text-8xl font-bold ml-[200px] mt-[150px] [text-shadow:_0_8px_0_rgb(0_0_0_/_40%)]'>
              Olá<br />Sou o <span className='text-green-400'>Henrique</span>,<br /> desenvolvedor front-end
            </p>
            <p className='ml-[200px] text-4xl w-[600px] mt-4 [text-shadow:_0_-5px_0_rgb(0_0_0_/_40%)]'>
              Apaixonado por criar e estilizar sites e aplicativos mobile, com proficiência em tailwind, css, html e react.
            </p>
          </div>
          <div className='mr-40 mt-32'>
            <nav>
              <ul className="text-7xl font-thin space-x-0 space-y-2 mr-[181px] mt-[131px] [text-shadow:_0_8px_0_rgb(0_0_0_/_40%)] animate-[spinner-grow_1s_ease-in-out]">
                ...
                <li><a href="#contatos" className="hover:before:scale-x-100 hover:before:origin-left relative before:w-full before:h-1 before:origin-right before:transition-transform before:duration-300 before:scale-x-0 before:bg-green-400 before:absolute before:left-0 before:bottom-0">Contato</a></li>
              </ul>
            </nav>
          </div>
        </div>
      ...
      <div id="sobre" className='bg-sobre container'>
        <WaveSVG />
        <div className='ml-[210px] flex'>
          <div className='ml-24 mt-14'>
            <h1 className='text-7xl text-center' data-aos="fade-down">Quem sou Eu?</h1>
            <hr className="head-separator" data-aos="fade-in" />
            <div>
              <p className='text-medium text-3xl w-[700px] mt-2' data-aos="fade-right" data-aos-delay='200'>Meu nome é Henrique Vergili, e sou desenvolvedor focado em front-end mobile e web!</p>
              <p className='text-medium text-3xl w-[700px] mt-2' data-aos="fade-left" data-aos-delay='400'>Meu interesse em programação começou na pandemia, onde decidi trancar minha faculdade de Direito e ingressar na PUC CAMPINAS em Engenharia de Software.</p>
              <p className='text-medium text-3xl w-[700px] mt-2' data-aos="fade-right" data-aos-delay='600'>Também sou apaixonado em música e em aprender instrumentos musicais!</p>
            </div>
            <div className='flex mt-10'>
              <a href="/Curriculo.pdf" data-aos="zoom-in" data-aos-delay='800' className='text-4xl text-left hover:before:scale-x-100 hover:before:origin-left relative before:w-full before:h-[1px] before:origin-right before:transition-transform before:duration-300 before:scale-x-0 before:bg-white before:absolute before:left-0 before:bottom-0 animate-[tada_1s_ease-in-out_infinite]' target="_blank" rel="noopener noreferrer">↓ currículo</a>
            </div>
          </div>

          <div className='mt-14'>
            <div className='relative z-40' data-aos="zoom-in">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 111.452 111.542"
                className="miniplayer-border-svg __web-inspector-hide-shortcut__ fill-white w-[189px] ml-[154px] mt-[-24px] absolute z-20 animate-spin"
              >
                ...
                <path d="M6.673,39.465l.11.043.075.03,5.147,2.029-.239.606-6.315-2.49.238-.606ZM5.58,39.354l.521.206-.113.286-.521-.2Zm2.05-4.633a3.073,3.073,0,0,1,1.247-.883,1.951,1.951,0,0,1,2.393.943,3.046,3.046,0,0,1,.313,1.5,4.949,4.949,0,0,1-.358,1.7,5.592,5.592,0,0,1-.849,1.438A3.633,3.633,0,0,1,9.1,40.458a1.775,1.775,0,0,1-1.473.052,1.747,1.747,0,0,1-1.028-1.042,3.737,3.737,0,0,1-.218-1.641A5.625,5.625,0,0,1,6.734,36.2,5,5,0,0,1,7.63,34.721Zm-.655,3.191a4.176,4.176,0,0,0,.1,1.46,1.157,1.157,0,0,0,.664.855,1.159,1.159,0,0,0,1.069-.171,4.228,4.228,0,0,0,1.072-1,4.9,4.9,0,0,0,.705-1.17,5.055,5.055,0,0,0,.328-1.363,2.747,2.747,0,0,0-.146-1.267,1.337,1.337,0,0,0-1.851-.73,2.757,2.757,0,0,0-.972.826,5.09,5.09,0,0,0-.69,1.22A4.872,4.872,0,0,0,6.975,37.912Zm4.389,3.752.1-.261.521.206-.205.522-.521-.206Z"></path>
              ...
              <a href='https://open.spotify.com/intl-pt/track/44mkUovCUkI5Pbx5Zu27sg' target='_blank' rel="noopener noreferrer">
                <div className='group bg-green-300 rounded-full w-[140px] mb-[-100px] ml-[180px] mt-[-55px] relative z-30 ' data-aos="zoom-in">
                  <img src='/polyphia.jpg' alt='Polyphia' className='w-[140px] rounded-full relative z-40 ' data-aos="zoom-in" />
            ...
            <img src='/eu.jpg' alt='Henrique Vergili' className='rounded-lg ml-64 skew-x-1 w-[450px]' data-aos="zoom-in" />
          </div>
        </div>
      </div> 
      ...
      <div id="projetos">
        <div className='container bg-swirl'>
          ...
          <div id='primeira linha' className='flex mt-[-80px] space-x-[400px] ml-[200px]'>
            {/*<a href="https://github.com/theneptunes/front-end" target="_blank" rel="noopener noreferrer" className="block">*/}
              <div className="relative group duration-500 ml-40 mt-20 cursor-pointer overflow-hidden text-gray-50 h-[600px] w-[400px] rounded-2xl hover:duration-700" data-aos="flip-up" data-aos-delay='300'>
                <div className="w-[600px] h-[300px] bg-fixed text-gray-800">
                  <img src='/qtivate1.png' alt='Qtivate' className='w-[400px] h-[600px]' />
                  <div className="flex flex-row justify-between">
                    <svg className="fill-current stroke-current w-8 h-8 p-2 hover:bg-lime-200 rounded-full m-1" height="100" preserveAspectRatio="xMidYMid meet" viewBox="0 0 100 100" width="100" x="0" xmlns="http://www.w3.org/2000/svg" y="0">
                      <path className="" d="M15.8,32.9V15.8m0,0H32.9m-17.1,0L37.2,37.2m47-4.3V15.8m0,0H67.1m17.1,0L62.8,37.2m-47,29.9V84.2m0,0H32.9m-17.1,0L37.2,62.8m47,21.4L62.8,62.8M84.2,84.2V67.1m0,17.1H67.1" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="8"></path>
                    </svg>
                    <svg className="fill-current stroke-current w-8 h-8 p-2 m-1 hover:bg-lime-200 rounded-full" height="100" preserveAspectRatio="xMidYMid meet" viewBox="0 0 100 100" width="100" x="0" xmlns="http://www.w3.org/2000/svg" y="0">
                      <path className="svg-stroke-primary" d="M50,17.4h0M50,50h0m0,32.6h0M50,22a4.7,4.7,0,1,1,4.7-4.6A4.7,4.7,0,0,1,50,22Zm0,32.7A4.7,4.7,0,1,1,54.7,50,4.7,4.7,0,0,1,50,54.7Zm0,32.6a4.7,4.7,0,1,1,4.7-4.7A4.7,4.7,0,0,1,50,87.3Z" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="8"></path>
                    </svg>
                  </div>
                </div>
            ...
            {/*</a>/*/}
              ...
              <div className="relative group duration-500 ml-0 mt-20 cursor-pointer overflow-hidden text-gray-50 h-[600px] w-[400px] rounded-2xl hover:duration-700" data-aos="flip-right" data-aos-delay='600'>
                <div className="w-[600px] h-[300px] bg-fixed text-gray-800">
                  <img src='/bees.png' alt='BeeBee' className='w-[400px] h-[600px]' />
                  <div className="flex flex-row justify-between">
                    <svg className="fill-current stroke-current w-8 h-8 p-2 hover:bg-lime-200 rounded-full m-1" height="100" preserveAspectRatio="xMidYMid meet" viewBox="0 0 100 100" width="100" x="0" xmlns="http://www.w3.org/2000/svg" y="0">
                      <path className="" d="M15.8,32.9V15.8m0,0H32.9m-17.1,0L37.2,37.2m47-4.3V15.8m0,0H67.1m17.1,0L62.8,37.2m-47,29.9V84.2m0,0H32.9m-17.1,0L37.2,62.8m47,21.4L62.8,62.8M84.2,84.2V67.1m0,17.1H67.1" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="8"></path>
                    </svg>
                ...
                <div className="absolute bg-gray-100 -bottom-24 w-[500px] h-[170px] p-3 flex flex-col gap-1 group-hover:-bottom-0 group-hover:duration-600 duration-500">
                  ...
                  <p className="text-neutral-900 w-[395px] ml-[-5px]">Aplicativo criado para auxiliar a manutenção de colmeias, onde é possivel monitorar peso e temperatura das colmeias e caso algum valor ultrapasse o recomendado um aviso é emitido ao usuário</p>
                </div>
              </div>
          ...
          <div id='segunda linha' className='flex space-x-[400px] ml-[200px]'>
              ...
              <div className="relative group duration-500 ml-40 mt-20 cursor-pointer overflow-hidden text-gray-50 h-[600px] w-[400px] rounded-2xl hover:duration-700" data-aos="flip-left" data-aos-delay='900'>
                <div className="w-[600px] h-[300px] bg-fixed text-gray-800">
                  <img src='/bluezone.png' alt='BlueZone' className='w-[400px] h-[600px]' />
                  <div className="flex flex-row justify-between">
                    <svg className="fill-current stroke-current w-8 h-8 p-2 hover:bg-lime-200 rounded-full m-1" height="100" preserveAspectRatio="xMidYMid meet" viewBox="0 0 100 100" width="100" x="0" xmlns="http://www.w3.org/2000/svg" y="0">
                      <path className="" d="M15.8,32.9V15.8m0,0H32.9m-17.1,0L37.2,37.2m47-4.3V15.8m0,0H67.1m17.1,0L62.8,37.2m-47,29.9V84.2m0,0H32.9m-17.1,0L37.2,62.8m47,21.4L62.8,62.8M84.2,84.2V67.1m0,17.1H67.1" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="8"></path>
                    </svg>
            ...
            <div className="relative group duration-500 ml-40 mt-20 cursor-pointer overflow-hidden text-gray-50 h-[600px] w-[400px] rounded-2xl hover:duration-700" data-aos="flip-right" data-aos-delay='600'>
              <div className="w-[600px] h-[300px] bg-fixed text-gray-800">
                <img src='/partiuparty.jpg' alt='Partiu.party' className='w-[400px] h-[600px]' />
                <div className="flex flex-row justify-between">
                  <svg className="fill-current stroke-current w-8 h-8 p-2 hover:bg-lime-200 rounded-full m-1" height="100" preserveAspectRatio="xMidYMid meet" viewBox="0 0 100 100" width="100" x="0" xmlns="http://www.w3.org/2000/svg" y="0">
                    <path className="" d="M15.8,32.9V15.8m0,0H32.9m-17.1,0L37.2,37.2m47-4.3V15.8m0,0H67.1m17.1,0L62.8,37.2m-47,29.9V84.2m0,0H32.9m-17.1,0L37.2,62.8m47,21.4L62.8,62.8M84.2,84.2V67.1m0,17.1H67.1" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="8"></path>
                  </svg>
              ...
              <div className="absolute bg-gray-100 -bottom-32 w-[500px] h-[200px] p-3 flex flex-col gap-1 group-hover:-bottom-0 group-hover:duration-600 duration-500">
                <span className="text-purple-500 font-bold text-sm">Ionic/React</span>
                <span className="text-gray-800 font-bold text-3xl">Partiu.party</span>
                <p className="text-neutral-900 w-[395px] ml-[-7px]">Projeto desenvolvido para uma escola em Jundiaí, com o objetivo de facilitar a organização de eventos, onde havia um aplicativo para comprar ingressos e itens nos eventos, e outro aplicativo para servir como quiosque físico para comprar produtos nos eventos</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className='animado container'>
          <div className='text-center'>
            ...
            <div className='mt-20 ml-[320px] list-disc'>
              ...
              <p className='text-2xl mt-4 text-left ml-20' data-aos="slide-right" data-aos-delay='1000'>Nível C1, conquistado em 2018</p>
              <li className='text-4xl text-left mt-4' data-aos="slide-right" data-aos-delay='950'>Certificados de React</li>
              <a href="/CertificadoReact1.pdf" target="_blank" rel="noopener noreferrer" className="block text-2xl mt-4 text-left ml-20" data-aos="slide-right" data-aos-delay="1000">
                React: desenvolvendo com JavaScript
              </a>
              <a href="/CertificadoReact2.pdf" target="_blank" rel="noopener noreferrer" className="block text-2xl mt-4 text-left ml-20" data-aos="slide-right" data-aos-delay="1000">
      ...
      <div id='contatos'>
        <div className='bg-contato container'>
          <div>
            <div className='flex justify-between mr-10 p-44 [text-shadow:_3px_5px_0_rgb(0_0_0_/_50%)]'>
              <div className='mt-60'>
                <p className='text-white text-4xl font-medium mt-7 aos-slide-down-custom' data-aos="fade-down" data-aos-delay='200'>Caso queira trabalhar comigo</p>
                <p className='text-white text-6xl font-bold' data-aos="fade-down" data-aos-delay='250'>Envie uma mensagem</p>
              </div>
              <div className='mt-60'>
                <p className="text-xl text-terra font-medium mb-2 mt-[60px]" data-aos="fade-down" data-aos-delay='300'>Email</p>
                <div>
                  <a href='mailto:henrique.vergili@hotmail.com' className='hover:text-blue-500 font-normal text-2xl text-white' data-aos="fade-down" data-aos-delay='350'>henrique.vergili@hotmail.com</a>
                </div>
              </div>
              <div>
                <p className="text-xl text-terra font-medium mb-2 mt-60" data-aos="fade-down" data-aos-delay='400'>Redes Sociais</p>
                <div className='flex' data-aos="fade-down" data-aos-delay='450'>
                  ...
                  <a href="https://www.instagram.com/henrique.vergili/" target="_blank" rel="noopener noreferrer" className="hover:text-pink-500 ml-1 text-white text-sm hover:underline focus:outline-none focus:underline">Instagram</a>
                </div>
                <div className='flex mt-1' data-aos="fade-down" data-aos-delay='500'>
                  ...
                  <a href="https://wa.me/15996639991" target="_blank" rel="noopener noreferrer" className="hover:text-green-300 ml-1 text-white text-sm hover:underline focus:outline-none focus:underline mt-1">Whatsapp</a>
                </div>
                <div className='flex mt-1' data-aos="fade-down" data-aos-delay='550'>
                  <span className="[&>svg]:h-7 [&>svg]:w-7 [&>svg]:fill-[#0077b5]">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                      <path d="M100.3 448H7.4V148.9h92.9zM53.8 108.1C24.1 108.1 0 83.5 0 53.8a53.8 53.8 0 0 1 107.6 0c0 29.7-24.1 54.3-53.8 54.3zM447.9 448h-92.7V302.4c0-34.7-.7-79.2-48.3-79.2-48.3 0-55.7 37.7-55.7 76.7V448h-92.8V148.9h89.1v40.8h1.3c12.4-23.5 42.7-48.3 87.9-48.3 94 0 111.3 61.9 111.3 142.3V448z" />
                    </svg>
                  </span>
                  <a href="https://www.linkedin.com/in/henrique-vergili-774642209/" target="_blank" rel="noopener noreferrer" className="hover:text-blue-300 ml-1 text-white text-sm hover:underline focus:outline-none focus:underline mt-1">Linkedin</a>
                </div>
              </div>
            </div>
            <hr className="head-separator mt-[-170px]" />
          </div>
        </div>
      </div>
    </div>
